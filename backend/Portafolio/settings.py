...
SECRET_KEY = 'django-insecure-9(lbw82579h)7)lddq$_l54ww#0j)%5l2wu_z2ta5+fet_0zqu'
...
CORS_ALLOWED_ORIGINS = [
    "http://127.0.0.1:8000", # Esto es común para Live Server
    "http://localhost:8000", # También por si acaso
]
